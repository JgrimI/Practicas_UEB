          ...
          <div id="form_estudiante" name="form_estudiante" style="display:none;">
            ...
            <form id="f_est" action="javascript:void(0);" onsubmit="reg();">
              ...
              <div class="input-group input-group-sm mb-3">
                <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" id="name" name="name" required onchange="verifyName();" placeholder="Digita tu nombre completo">
              </div>
              <div class="alert alert-danger mb-0" role="alert" id="alert_mail" style="display:none;"></div>
              <label>Correo institucional</label>
              <div class="input-group input-group-sm mb-3">
                <input type="email" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required id="mail" name="mail" onchange="verifyMail();" placeholder="Ingresa tu correo">
              </div>
              ...
              <div class="input-group input-group-sm mb-3">
                <input type="password" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" id="pass" name="pass" required onchange="verifyPass();" placeholder="Digita tu contraseña">
              </div>
              <label>Confirmar Contraseña</label>
              <div class="input-group input-group-sm mb-3">
                <input type="password" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" id="verify" name="verify" required onchange="verifyPass();" placeholder="Verifica tu contraseña">
              </div>
