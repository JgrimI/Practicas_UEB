...
<style>
    ...
    * {
    ...
    #msform .action-button:focus {
        box-shadow: 0 0 0 2px white, 0 0 0 3px #008375
    }
                            ...
                            <div class="row justify-content-center mt-0">
                                <div class="col-11 col-sm-9 col-md-7 col-lg-11 text-center p-0 mt-3 mb-2">
                                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        ...
                                        <p>Llena todos los campos para pasar al siguiente paso</p>
                                        <div class="row">
                                            <div class="col-md-12 mx-0">
                                                <form id="msform">
                                                    ...
                                                    <fieldset>
                                                        <div class="form-card">
                                                            <h2 class="fs-title">Account Information</h2> <input type="email" name="email" placeholder="Email Id" />
                                                        ...
                                                        <div class="form-card">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-9"> <label class="pay">Card
                                                                        Number*</label> <input type="text" name="cardno" placeholder="" /> </div>
