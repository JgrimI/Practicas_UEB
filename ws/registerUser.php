    ...
    $PHPmail->MsgHTML('
            ...
            <div style=" margin-left: 5%; margin-right: 5%; padding-top: 5%; padding-bottom: 5%;">
                ...
                <div style="margin-left: 10%; margin-right: 10%;"><br><br>
                    ...
                    <center><a href="localhost/Practicas_UEB/index.php?id='.base64_encode($id).'" style="background-color:#f3984d;border:10px solid #f3984d;text-decoration:none;color:#fff" target="_blank">Activar Cuenta</a></center>
                    <br><br>
                </div>
                    <br><br><br><br>
